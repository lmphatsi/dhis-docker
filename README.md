...
3. Make changes to the **config/dhis2_home/dhis.conf** file. e.g. setting a strong password *(Optional if this is for testing purposes)*
...
6. Go to localhost:8080 or *Machine_IP*:8080
